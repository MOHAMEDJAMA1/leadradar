        ...
        <div className="space-y-5">
            ...
            <form onSubmit={handleEmailSignup} className="space-y-4" noValidate>
                <div>
                    ...
                    <input id="signup-email" type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@agency.com" required autoComplete="email" disabled={loading} aria-required="true" className={inputCls} />
                </div>
                <div>
            ...
            <p className="text-center text-xs text-slate-700">
                ...
                <a href="#" className="text-slate-500 hover:text-slate-400 underline underline-offset-2 transition-colors">Terms of Service</a>
                {' '}and{' '}
